if status is-interactive
    function __add_abbr
        ...
        abbr -a gc! "git commit -vs --amend"
        abbr -a gcn! "git commit -vs --no-edit --amend"
        abbr -a gca "git commit -vsa"
        abbr -a gca! "git commit -vsa --amend"
        abbr -a gcan! "git commit -vsa --no-edit --amend"
        abbr -a gcam "git commit -asm"
